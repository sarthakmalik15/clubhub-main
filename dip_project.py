# Group 8 — Digital Image Processing Project
# Gesture Based Paint Tool using OpenCV
...
blueLower = np.array([60, 60, 100])
blueUpper = np.array([255, 255, 140])
...
while True:
    ...
    if len(cnts) > 0:
        ...
        # we will assume this contour correspondes to the area of the bottle cap
